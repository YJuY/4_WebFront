...
btn1.addEventListener("click", function(){
    ...
    window.setTimeout(function(){
        ...
        // console.log(this);
        // this.style.backgroundColor = "oreange";
...
function currentTime(){
    const now = new Date(); // 현재 시간 정보를 저장하고 잇는 객체 생성
...
openPopup3.addEventListener("click", function(){
    ...
    const option = "width=400, height=500, top=50, left=100";

    window.open("09_배열.html", "popupWindow", option)
});

// 팝업창(자식) 열기
document.getElementById("sendChild").addEventListener("click", function(){
    const option = "width=300, height=300, top=50, left=700";
    window.open("팝업.html", "popupWindow", option)
})