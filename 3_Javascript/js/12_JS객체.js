...
document.getElementById("btn1").addEventListener("click", function() {
    ...
    const product = {
        ...
        'information' : function(){ // 객체의 기능
            ...
            // 해당 객체의 변수(key)가 아닌
            // 전역변수가 선택된다.
            // 왜? 같은 객체의 변수(key)를 선택하는 방법이 별도로 존재해서
    ...
    //for(let key in 객체명) :  매 바퀴바다 객체의 K를 하났기 얻어와 
    //                            key 변수에 저장
...
function Student(grade, ban, name){
    // JS 함수의 매개변수는 let, const, vwr를 적지 않음!
    ...
    // 속성
    this.grade = grade;
    // 매개변수 grade값을 생성되는 객체의 grede에 대입
    this.ban = ban;
    this.name = name;
