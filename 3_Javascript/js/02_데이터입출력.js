...
function getInnerText1(){
    // clg 자동 완성 -> consloe.log() (단, JS ES6 code snippets 필요)
...
// confirm
function fnConfirm(){
   //console.log(window.confirm("테스트")); //  ture / false 반환 확인

   // 조건문(if, switch) 작성법은 Javs와 동일
